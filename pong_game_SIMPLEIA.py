"""
In this second part of the project, we'll set up a strategy that'll allow our future IA model to learn
The approach is simple : We'll create a player (SIMPLE IA). This paddle will follow the ball verticaly.
In this way, we simulate the human actions, decisions... and the agent Q_learning will learn correctly

We can maintain our code for simple pong game and just add the function for following the ball no matter its position
"""
...
class Paddle(pygame.sprite.Sprite):
    ...
    """
    @params : ball_position_y : Because we need the follow the ball verticaly, so we need to have the position of the ball
    """
